...
\begin{document}
	...
	%TODO Add text explaining the purpose of the requirements,
...
\end{itemize}		
    ...
    %TODO Fix the weird outlining (caused by longtable?)
