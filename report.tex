...
\end{itemize}		
    ...
    \textbf{MCF9a}
    \begin{multline*}
        \forall w1 \in \mathit{Wafer}, s \in SluiceID.[true^{\star} \cdot (RobotToSluice(Rb,s,w2) \cup RobotToSluice(Ra,s,w2)) \\
        \cdot \overline{RobotFromSluice(Ra,s,w1) \cup RobotFromSluice(Rb,s,w1))}^{\star} \\ 
        \cdot  \exists w2 \in \mathit{Wafer}. (RobotToSluice(Rb,s,w2) \cup RobotToSluice(Ra,s,w2))]false
    \end{multline*}
    ...
    \textbf{MCF10a}
    \begin{multline*}
        \nu X(i=0). \forall s \in SluiceID, \forall w1,w2 \in \mathit{Wafer}. \\
        [\overline{RobotToSluice(Rb,s,w1) \cup RobotFromSluice(Ra,s,w2)}] X(i) \\
    ...
    \begin{multline*}
        \nu X(i=0). \forall s \in SluiceID, \forall w1,w2 \in \mathit{Wafer}. \\
        [\overline{RobotToSluice(Ra,s,w1) \cup RobotFromSluice(Rb,s,w2)}] X(i) \\
    ...
    \begin{multline*}
        ...
        (p \leq RackSize) \rightarrow [\overline{RobotToRack(Rb,p,w1) \cup RobotToRack(Rc,p,w2)}]X(i) \\
    ...
    \begin{multline*}
        \nu X(i=0). \forall w1,w2 \in \mathit{Wafer}. \forall p \in \mathbb{N}. \\
        (p \leq RackSize) \rightarrow [\overline{RobotToRack(Rc,p,w1) \cup RobotToRack(Rb,p,w2)}]X(i) \\
